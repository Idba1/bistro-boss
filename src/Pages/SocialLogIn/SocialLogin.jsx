...
const SocialLogin = () => {
    ...
    return (
        ...
        <>
            <a  onClick={() => handleSocialLogin(googleLogin)} href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-sky-600 transition-colors duration-300 transform border rounded-lg dark:border-sky-700 dark:text-sky-950hover:bg-sky-50 dark:hover:bg-sky-600">
            ...
            <a onClick={() => handleSocialLogin(githubLogin)} href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-sky-600 transition-colors duration-300 transform border rounded-lg dark:border-sky-700 dark:text-sky-950hover:bg-sky-50 dark:hover:bg-sky-600">
